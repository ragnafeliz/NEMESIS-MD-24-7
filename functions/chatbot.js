...
async function handleAIChatbot(m, clutch, body, from, isGroup, isCmd, prefix) {
    try {
        ...
        // don't respond to these numbers 
        ...
        await clutch.sendPresenceUpdate('composing', from);
        ...
        if (isAskingAboutCreator) {
            ...
            response = "I am NEMESIS AI, created by Kelvin Tech And Ridz Coder - a brilliant developer from Uganda with exceptional coding skills and vision. He's the mastermind behind my existence, crafting me with precision and care to be your helpful assistant.";
        } else {
            ...
            const prompt = `You are NEMESIS AI, a powerful WhatsApp bot developed by Kelvin Tech from Uganda. 
